...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    ...
    oneSignalConfig: Attribute.JSON;
    maintainence: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    order_product: Attribute.String & Attribute.Required;
...
export interface ApiRequestWebRequestWeb extends Schema.CollectionType {
  collectionName: 'request_webs';
  info: {
    singularName: 'request-web';
    pluralName: 'request-webs';
    displayName: 'request_web';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    added: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::request-web.request-web',
...
export interface ApiWebsiteWebsite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    country: Attribute.Enumeration<
      ['UK', 'USA', 'Dubai', 'Saudi', 'China', 'Kenya']
    >;
